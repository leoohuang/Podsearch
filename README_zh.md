...
<p align="center">
  一个面向播客内容库的 AI 语义搜索系统，支持中英文检索、时间戳级命中结果，以及可直接回放的音频片段。
</p>
...
<p align="center">
  <img src="https://img.shields.io/badge/任务-播客语义搜索-111827?style=flat-square" alt="Task" />
  <img src="https://img.shields.io/badge/检索-两阶段排序-1D4ED8?style=flat-square" alt="Two-stage ranking" />
  <img src="https://img.shields.io/badge/语言-中文%20%2F%20英文-059669?style=flat-square" alt="Chinese and English" />
  <img src="https://img.shields.io/badge/状态-本地原型-F59E0B?style=flat-square" alt="Prototype" />
</p>

PodSearch 是一个面向播客资料库的 AI 检索系统。它会自动下载播客音频、完成带时间戳的转写、构建多语言向量索引，并根据自然语言查询返回最相关的音频片段。
...
- 播客内容一旦积累到多节目、多期数，单靠顺序收听很难高效回看。
- 传统关键词搜索对口语表达、同义改写和中英文混合内容并不友好。
- PodSearch 用 ASR、向量检索和精排，把音频内容变成可按语义定位的知识库。
